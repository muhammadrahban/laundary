...
$msg = "Failed to upload image";
 ...
 $q1="UPDATE `brand` SET `b_name`='$b_name' WHERE `Id`='".$_GET['id']."'"; 
//$q2=$conn->query($q1);
...
if ($conn->query($q1) === TRUE) {
    ...
    include("Activity.php");
        ...
        $apple = new Act('Edit Brand ',$u,$rooo[1],$pc,$da);
        $apple->actt();
...
window.location="view_brand.php";
</script>
<?php
} else {
...
<?php
$que="select * from brand where id='".$_GET["id"]."'";
...
<div class="col-sm-9">
<input type="text" name="b_name" class="form-control" placeholder="Brand Name" id="event" onkeydown="return alphaOnly(event);" value="<?php echo $name; ?>" required="">
</div>
</div>
</div>
