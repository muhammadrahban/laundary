...
$msg = "Failed to upload image";
 ...
 $q1="UPDATE `category` SET `Name`='$name' WHERE `Id`='".$_GET['id']."'"; 
//$q2=$conn->query($q1);
...
if ($conn->query($q1) === TRUE) {
    ...
    include("Activity.php");
        ...
        $apple = new Act('Edit Category ',$u,$rooo[1],$pc,$da);
        $apple->actt();
...
<?php
$que="select * from category where id='".$_GET["id"]."'";
...
<div class="col-sm-9">
<input type="text" name="name" class="form-control" placeholder="Category Name" id="event" onkeydown="return alphaOnly(event);" value="<?php echo $name; ?>" required="">
</div>
</div>
</div>
