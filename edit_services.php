...
$msg = "Failed to upload image";
 ...
 $q1="UPDATE `service` SET `sname`='$name',`prize`='$pri' WHERE `id`='".$_GET['id']."'"; 
//$q2=$conn->query($q1);
...
if ($conn->query($q1) === TRUE) {
    ...
    include("Activity.php");
        ...
        $apple = new Act('Edit Services ',$u,$rooo[1],$pc,$da);
        $apple->actt();
...
<h3 class="text-primary">Services Management</h3> </div>
...
<div class="col-sm-9">
<input type="text" name="name" class="form-control" placeholder="Service Name" id="event" onkeydown="return alphaOnly(event);" value="<?php echo $sname; ?>" required="">
</div>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-9">
<input type="text"  name="pri" id="lname" class="form-control" id="event"  placeholder="Price" value="<?php echo $price; ?>" required="">
</div>
</div>
</div>
