...
?>
    ...
    <div id="main-wrapper">
        <div class="unix-login">
             ...
             ?>
           <div class="container-fluid" style=" height:900px;background-image: url('uploadImage/Logo/<?php echo $row_login['background_login_image'];?>');background-color: #cccccc; background-position: center;background-repeat: no-repeat;background-size: cover;">
